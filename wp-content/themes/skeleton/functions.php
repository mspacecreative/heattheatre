...
function st_navbar() {
	echo '<div id="navigation" class="row sixteen columns">';
		...
		echo '<div id="nav_to_middle">';

			echo '<div id="half_nav_left" class="to_middle">';
				wp_nav_menu( array( 'theme_location' => 'menu1' ) ); 
			echo '</div>';

			?>
			<a href="http://heattheatre.com"><img class="to_middle" src="http://heattheatre.com/site/wp-content/uploads/2013/03/logo_good.png"></a>
			<?php
			
			echo '<div id="half_nav_right" class="to_middle">';
